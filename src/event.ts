 ...
 */
type SyfrDebugEvent = CustomEvent<SyfrDebugEventDetail>;

/**
 * Valid `CustomEvent.detail` indicates users can validate your form encryption with Syfr.
 * @see https://developer.mozilla.org/en-US/docs/Web/API/CustomEvent
 */
type SyfrValidEventDetail = { id: string; validateUrl: string };

/**
 * Emitted when Syfr has loaded the form's public `CryptoKey`
 */
type SyfrValidEvent = CustomEvent<SyfrValidEventDetail>;
 ...
 */
type SyfrTransmitEvent = CustomEvent<SyfrTransmitEventDetail>;
 ...
 */
type SyfrRequestEvent = CustomEvent<SyfrRequestEventDetail>;
