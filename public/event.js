...
export class SyfrEvent {
    static debug(form, detail) {
        form.dispatchEvent(new CustomEvent("debug", { detail }));
    }
    static valid(form, detail) {
        form.dispatchEvent(new CustomEvent("valid", { detail }));
    }
    static transmit(form, detail) {
        form.dispatchEvent(new CustomEvent("transmit", { detail }));
    }
    static request(form, detail) {
        form.dispatchEvent(new CustomEvent("request", { detail }));
    }
}
