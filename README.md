...
The minified javascript is available at: https://js.syfr.app/2.4.0/form-cipher.min.js

Integrity SHA values at: https://js.syfr.app/2.4.0/assets-manifest.json
