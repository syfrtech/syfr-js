...
- [Standard Script](https://js.syfr.app/2.4.1-beta.20/form-cipher.min.js)
- [Manual Script](https://js.syfr.app/2.4.1-beta.20/form-cipher-manual.min.js)
- [Assets Manifest with subresource-integrity values](https://js.syfr.app/2.4.1-beta.20/assets-manifest.json)
...
<html>
  <head>
    <script
      defer
      src="https://js.syfr.app/2.4.1-beta.20/formCipher.min.js"
