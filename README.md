...
The minified javascript is available at: https://js.syfr.app/2.4.1-beta.1/form-cipher.min.js

Integrity SHA values at: https://js.syfr.app/2.4.1-beta.1/assets-manifest.json
