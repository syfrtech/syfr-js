...
The minified javascript is available at: https://js.syfr.app/2.1.1/form-cipher.min.js

Integrity SHA values at: https://js.syfr.app/2.1.1/assets-manifest.json
